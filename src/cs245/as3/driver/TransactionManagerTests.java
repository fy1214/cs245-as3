...
public class TransactionManagerTests {
	...
	@Rule
    public Timeout globalTimeout = Timeout.seconds(1000000);
   ...
   public void TestRecoveryPerformance2() {
    ...
    public void TestRepeatedFailuresTemplate(final Random seeds, double failureRate) {
		...
		//在多次撞车后，真正的压力是恢复。我们确保至少第一次成功。
		//通过选择这些要持久化的密钥，我们确保始终必须重播整个日志，
		//同时还测试不处理某些键但不持久化其他键的提交。
